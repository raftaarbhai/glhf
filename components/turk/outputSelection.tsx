...
export default function OutputSelection() {
    ...
    const handleSubmit = async (e) => {
        ...
        const { error } = await supabase
            .from('data')
          .insert({ prompt: textContent, "response-1":'test', "response-2": "selected", "response-3": "another", "response-4": "final", selected: "prompt", category: "rlhf" })
  ...
  return (
    <>
      <EditableScroll promptGenerated={promptGenerated} generatePrompts={generatePrompts} textContent={textContent} setTextContent={setTextContent}/>
